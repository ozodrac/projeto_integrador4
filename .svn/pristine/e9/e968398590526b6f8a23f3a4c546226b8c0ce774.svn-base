		...
		<div id="content">
			...
			<div class="clear">
				<ul class="formee-list">
					<li><input type="submit" name="acao" value="<%= bundlePage.getString("resetar_senha") %>" /></li>
					<li><a href="<%= MapConfig.getInstance().get("CONFIG-DIR_ROOT") + "/" %>"><input type="button" name="acao" value="<%= bundlePage.getString("cancelar") %>" /></a></li>
				</ul>
			</div>
