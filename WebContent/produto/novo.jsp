...
<div id="wrapper">
	...
	<form id="formulario"action="<%= MapConfig.getInstance().get("CONFIG-DIR_ROOT", "CONFIG-DIR_PRODUTO") + "/" %>" method="post" class="formee">
		...
		<div id="toolbar">
			<h1><a href="<%= MapConfig.getInstance().get("CONFIG-DIR_ROOT", "CONFIG-DIR_PRODUTO")+"/" %>"><%= bundlePage.getString("label_produto") %></a> &gt;&gt; <%= bundlePage.getString("label_cadastrar") %></h1>
			<ul id="buttons">
